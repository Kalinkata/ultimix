		...
		function			create( $Record )
		{
			try
			{
				$Record = $this->SecurityParser->parse_parameters( 
					$Record , 
					'package_name:string;package_version:string,allow_not_set;type:integer,allow_not_set;'.
						'time_step:integer,allow_not_set;archived:integer,allow_not_set;'.
						'parameters:string,allow_not_set;next_processing_time:integer,allow_not_set'
				);
		...
		*/
		function			simple_select()
		{
			try
			{
				...
				{
					$Records[ $k ]->title = $v->package_name.'.'.$v->package_version.$v->parameters;
				}
		...
		*/
		function			update( $id , $Record )
		{
			try
			{
				...
				$Record = $this->SecurityParser->parse_parameters( 
					$Record , 
					'package_name:string;package_version:string;type:integer;time_step:integer;archived:integer;'.
						'parameters:string;next_processing_time:integer;processing:integer' , 'allow_not_set'
				);
