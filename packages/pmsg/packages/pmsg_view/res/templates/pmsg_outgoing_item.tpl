						<tr class="grid_row">
							...
							<td align="left" class="table_row_{odd_factor}"><nobr>{creation_date}{dialog:modal=false;cancel=true;selector=#record_view_{id}_out;opener=#record_view_opener_{id}_out}{template_content:package_name=pmsg::pmsg_view;template=record_view_out.tpl}</nobr></td>
						</tr>