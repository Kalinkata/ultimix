						<tr class="grid_row">
							<td class="table_row_{odd_factor}" valign="top">{item_checkbox:name=pmsg_i;id={id}}</td>
							...
							<td align="left" class="table_row_{odd_factor}"><nobr>{creation_date}</nobr>{dialog:on_open=ultimix.pmsg.SetRead( {id} );modal=false;cancel=true;selector=#record_view_{id}_in;opener=#record_view_opener_{id}_in}{template_content:package_name=pmsg::pmsg_view;template=record_view_in.tpl}</td>
						</tr>