<form id="{prefix}_create_form" method="post" action="" class="form_330">
	...
	<table width="100%">
		...
		<tr>
			<td>
				<input type="text" class="width_240 flat" name="master_package_name" value="{http_param:post=1;name=master_package_name;default=}">&nbsp;<input type="text" class="width_70 flat" name="master_package_version" value="{http_param:post=1;name=master_package_version;default=}">
			</td>
		</tr>
		<tr>
			<td>
