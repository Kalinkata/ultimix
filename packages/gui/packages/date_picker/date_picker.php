	...
	*/
	class	date_picker_1_0_0
	{
		...
		*/
		...
		/**
		*	\~russian Функция обработки макроса 'date_picker'.
		*
		...
		*/
		/**
		*	\~english Function processes macro 'date_picker'.
		*
		...
		*	@author Dodonov A.A.
		*/
		function			process_date_picker( $Str , $Changed )
		{
			try
			{
				$Limitations = array( 'value' => TERMINAL_VALUE );

				for( ; $Parameters = $this->String->get_macro_parameters( $Str , 'date_picker' , $Limitations ) ; )
				{
					$this->Settings->load_settings( $Parameters );
					
					$Code = $this->compile_date_picker( $this->Settings );

					$Str = str_replace( "{date_picker:$Parameters}" , $Code , $Str );
		...
		*/
		function			process_string( $Options , $Str , &$Changed )
		{
			try
			{
				list( $Str , $Changed ) = $this->process_date_picker( $Str , $Changed );
