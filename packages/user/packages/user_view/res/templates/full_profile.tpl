<table cellpadding="0" cellspacing="0" border="0" class="form_450">
	...
	{composer:condition={eq:value1={user_id};value2={id}}}<tr><td valign="top" colspan="3" align="right">{href:page=./update_profile.html;text=update_profile}</td></tr>{~composer}
</table>