						...
						<tr class="grid_row">
							...
							<td align="left" class="table_row_{odd_factor}" {update_record:id={id};prefix={prefix}} id="active_{id}">{if:condition={eq:value1=active;value2={active}};then={lang:active};else={lang:not_active}}</td>
