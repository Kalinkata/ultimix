		...
		*/
		function			pre_generation( $Options )
		{
			try
			{
				...
				$PackagePath = _get_package_relative_path_ex( 'comment::comment_view' , '1.0.0::1.0.0' );
				$PageJS->add_javascript( "{http_host}/$PackagePath/include/js/comment_view.js" );
				
				$Lang = get_package( 'lang' , 'last' , __FILE__ );
				$Lang->include_strings_js( 'comment::comment_view' );
			}
			catch( Exception $e )
			{
