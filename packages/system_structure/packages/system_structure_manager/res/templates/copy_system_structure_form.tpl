						...
						<table>
							...
							<tr>
								<td valign="top">
									...
									<input class="width_320 flat" type="text" name="{prefix}_page" value="{form_value:name=page;type=string}">
								</td>
							</tr>
							<tr>
								<td valign="top">
							...
							<tr>
								<td valign="top">
									...
									<input class="width_320 flat" type="text" name="{prefix}_root_page" value="{form_value:name=root_page;type=string}">
								</td>
							</tr>
							<tr>
								<td valign="top">
							...
							<tr>
								<td valign="top">
									...
									<textarea class="width_320 flat height_320" name="{prefix}_navigation">{form_value:name=navigation;type=raw}</textarea>
								</td>
							</tr>
