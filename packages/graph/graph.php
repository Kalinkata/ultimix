<?php
	...
	*/
	class	graph_1_0_0{
		...
		*	@author Dodonov A.A.
		*/
		function			compile_client_width_height( $ClientX = 20 , $ClientY = 20 , $Width = 0 , $Height = 0 )
		{
			try
			{
		...
		*	@author Dodonov A.A.
		*/
		private function	set_width_height()
		{
			try
			{
		...
		*	@author Dodonov A.A.
		*/
		private function	init_client_area()
		{
			try
			{
		...
		*	@author Dodonov A.A.
		*/
		private function	prepare_graph_area()
		{
			try
			{
		...
		*	@author Dodonov A.A.
		*/
		private function	draw_graph_data( &$Options )
		{
			try
			{
